...
List<ReposModel> reposModelFromJson(String str) =>
    List<ReposModel>.from(json.decode(str).map((x) => ReposModel.fromJson(x)));

String reposModelToJson(List<ReposModel> data) =>
